...
- **📄 Modelo** — baixa uma planilha em branco, com 6 linhas (uma por Slot) e as colunas certas, pronta pra preencher à mão numa planilha e depois importar. Só a Espécie é obrigatória por linha — deixe uma linha totalmente em branco pra esse Slot ficar vazio. O Método de cada Movimento aceita **Nível/Evo/TM/Egg/Anterior** (mesmos nomes dos botões da ficha).
