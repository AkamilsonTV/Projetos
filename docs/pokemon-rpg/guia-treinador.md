...
1. **Clique no seu Pokémon** (só quando for a vez dele, se houver uma Rodada ativa). Ele já está visível pra mesa inteira desde que foi revelado — clicar pra agir não muda nada nessa parte, só abre o menu.
...
2. Se a ação seguir, abre um menu com quatro opções: **Atacar**, **Usar Item**, **Trocar de Pokémon**, **Fugir**.
   - **Atacar** → escolha um dos Movimentos do seu Pokémon — cada um já mostra **quem pode ser alvo** dele ("Alvo: em você mesmo", "só aliado", "aliado ou inimigo" etc.) e a Prioridade, se tiver. Sem PP, o Movimento fica bloqueado (custa 1, ou 2 se o alvo tiver a Habilidade Pressure — Cap. 8.6) — some sozinho assim que o Movimento é usado de verdade. A lógica de cada Movimento é respeitada de verdade — o site não deixa escolher qualquer coisa:
     ...
     - **Negociação de Prioridade (Cap. 17.1-17.3)**: assim que o Movimento de alguém resolve de vez, o site confere sozinho se sobra alguém do lado oposto — com uma Rodada ativa, ainda sem ter agido nela — que tenha, no próprio conjunto de 4, um Movimento com Prioridade **maior** que a que acabou de ser usada (empate não conta — quem já estava agindo continua na frente). Se tiver, aparece uma pergunta pro dono desse Pokémon (ou o Mestre): *"Seu oponente usou X, mas você possui Y que tem uma prioridade Z. Deseja usar Y?"* — **Sim** já resolve o Y de verdade na hora (contra quem provocou a pergunta) e **encerra o turno desse Pokémon**: ele não age de novo quando a fila normal chegar nele, porque já adiantou a própria vez; **Não** só descarta a pergunta, sem gastar nada, e ele continua livre pra agir normalmente (ou reagir de novo depois, se outro Movimento abrir uma nova pergunta antes da vez dele chegar). Cada Pokémon só reage **uma vez por Rodada**. Enquanto uma pergunta estiver pendente, ninguém mais consegue agir até ela ser respondida — pode inclusive abrir uma NOVA pergunta em cadeia, se a própria reação também acabar de resolver e sobrar alguém com Prioridade ainda maior do lado oposto a ela.
   - **Usar Item** → a mochila aparece separada por tipo (💊 Vida, ✨ Condição, 💫 Reviver, 🔄 Vida + Condição, 🔋 PP, 📦 Outro), igual na Mochila da ficha — Pokébola não aparece aqui também, pelo mesmo motivo (sem sistema de captura ainda). Escolha o item e depois em quem usar (você mesmo ou um aliado em campo) — a lista de alvos já respeita a trava de desmaiado (Vida/Vida+Condição/PP só em quem está de pé, Reviver só em quem está desmaiado). Pra um item de PP que afeta um Movimento só (Ether, Max Ether, PP Up, PP Max), o site ainda pede pra escolher qual dos 4 Movimentos recebe. Itens de Vida, Condição, Reviver, Vida+Condição e PP já fazem efeito de verdade na hora — PV sobe, Condição/Confusão some, o Pokémon reanima e/ou o PP do Movimento aumenta — e o Log mostra o resultado. Itens de Outro tipo ainda não têm efeito mecânico (Cap. 25): só consomem 1 unidade e ficam registrados.
   - **Trocar de Pokémon** → não precisa arrastar nada: a sua **Equipe ativa**, lá embaixo, fica com os Pokémon disponíveis destacados — clique em qualquer um deles (vivo, e que ainda não esteja em campo em outro lugar) pra colocar ele no lugar do atual. O Pokémon que estava lutando volta a aparecer só na Equipe ativa (some do Time), e o novo entra revelado direto. Consome a ação inteira (Cap. 18) — o que entrou só age a partir do turno seguinte dele. Esse mesmo seletor também é o que abre sozinho depois de U-turn/Volt Switch/Parting Shot, e o que aparece quando um dos seus desmaia e ainda sobra alguém — ver "Desmaio e vitória" abaixo.
