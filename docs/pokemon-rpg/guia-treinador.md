...
- **📊 Ver atributos**: todo card em campo (o seu ou o de qualquer outro Time, contanto que já esteja revelado) tem um botãozinho **"📊"** no canto — clicar nele abre um **painel flutuante** com o preview completo daquele Pokémon: Tipo, PV atual/máximo, Condição/Confuso, Habilidade (com o efeito dela), Natureza e uma tabela com o Estágio e o Atributo Efetivo de verdade (o mesmo número que o motor de ataque usa) de cada Atributo, além dos Movimentos com o PP restante. O painel é **arrastável** — segure na barrinha do topo dele e solte onde quiser na tela — e some com o **✕**. Ele é só seu: cada um na mesa abre, fecha e arrasta o próprio painel sem afetar o que os outros estão vendo.
...
Com uma Rodada ativa, **só quem está com a vez consegue agir** — os outros veem o próprio Pokémon "esperando" até a fila chegar nele (o Mestre é a exceção, pode agir por qualquer um fora de ordem, é assim que ele adjudica a negociação de Prioridade, Cap. 17). Sem Rodada ativa, continua liberado. Quando o dono do Pokémon que está com a vez ataca, a fila passa pro próximo sozinha; fora isso, quem estiver com a vez (ou o Mestre) clica em **"⏭️ Próximo"** pra passar adiante manualmente.
