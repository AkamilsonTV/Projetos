...
Você mesmo escolhe os 4 Movimentos do seu Pokémon — mas só entre o que a espécie realmente pode aprender (não dá pra digitar qualquer coisa). Pra cada um dos 4 slots, tem uma barra **"Learnset"** com as opções:
...
- **Anterior** (só aparece se a espécie tiver uma pré-evolução): os Movimentos por Nível de qualquer forma ANTERIOR na cadeia de evolução — ex.: um Charizard pode pegar algo do Learnset por Nível do Charmeleon ou do Charmander, respeitando o mesmo teto de Nível de sempre. O menu mostra "Nome (Espécie, Nv. X)" pra deixar claro de onde veio. É sempre retroativo — nunca dá pra "roubar" Movimento de uma evolução posterior nem de uma forma irmã (ex.: Vaporeon não empresta nada pra Jolteon, mesmo os dois vindo de Eevee).

Clique no método (Nível/Evo/TM/Egg/Anterior) e depois escolha o Movimento no menu que aparece — Tipo, Categoria, Poder, **PP**, Prioridade, Precisão e a Descrição são preenchidos sozinhos. Se a lista aparecer vazia, é porque a espécie não tem nada disponível ali (ou você ainda não subiu Nível suficiente, no caso do Nível/Anterior). Não existe mais opção de HM — os jogos oficiais tiraram essa mecânica a partir da Geração 9.
...
### Exportar/Importar CSV da Equipe

Logo abaixo da Equipe tem três botões:

- **⬇️ Exportar CSV** — baixa a Equipe atual (até 6 Pokémon) numa planilha, com Espécie/Apelido/Natureza/Habilidade/Movimentos de cada um. Qualquer pessoa que vê a ficha pode exportar (é só leitura) — útil pra guardar um backup antes de o Mestre importar algo novo.
- **⬆️ Importar CSV** — só o **Mestre** vê esse botão (é ele quem define Espécie/Natureza/Habilidade, então é ele quem importa). Escolher um arquivo mostra um resumo (quantos Pokémon têm no arquivo, quantos existem hoje, e qualquer aviso — Espécie que não bateu com nenhuma da Pokédex, Movimento inválido pra aquela Espécie/Nível etc.) antes de confirmar. **Importar SUBSTITUI a Equipe inteira** pelo conteúdo do arquivo — por isso vale exportar a Equipe atual primeiro, se quiser guardar o que já estava lá. Vínculo, Maturidade e Atributos Naturais **não** entram no CSV — continuam sendo só da própria ficha, editados à mão como sempre.
- **📄 Modelo** — baixa uma planilha em branco, com 6 linhas (uma por Slot) e as colunas certas, pronta pra preencher à mão numa planilha e depois importar. Só a Espécie é obrigatória por linha — deixe uma linha totalmente em branco pra esse Slot ficar vazio. Pra cada Movimento é só escrever o **nome** (ex.: "Flamethrower") — não tem coluna de Método: o site descobre sozinho se aquele Movimento vem de Nível, Evo, TM, Egg ou Anterior, testando nessa ordem até achar onde a Espécie realmente aprende ele. Um nome que a Espécie não aprende de jeito nenhum (erro de digitação, ou Movimento que ela realmente não tem) vira um aviso e aquele slot fica vazio, sem travar o resto da linha.

O CSV guarda só a "montagem" do Pokémon (o que também vale de fora de batalha) — nunca PV atual nem Condição, que sempre voltam "descansados" (PV cheio, sem Condição) depois de importar.
...
O botão **"🏟️ Arena"** no topo abre um espaço à parte pra montar uma batalha. Redesenhada com a cara do PVP — menos telas, menu de ação no fluxo normal da página (não é mais um popup por cima de tudo).

- **Antes do Mestre começar, você vê o clima, o Registro e, assim que existir pelo menos 1 Time criado, um jeito de você mesmo escolher o seu**: aparece um botão por Time ("Escolha o seu Time") — clique no que você quer entrar. Depois de escolhido, a tela mostra em qual Time você está, com um botão pra **sair** ou **trocar** pra outro, a qualquer momento antes do combate começar. O Mestre também pode montar os Times por você a qualquer momento (os dois jeitos mexem na mesma coisa) — e é sempre ele quem clica em "Iniciar Combate" quando estiver tudo pronto.
- **Assim que o combate começa, você entra automaticamente** com o **primeiro Pokémon vivo** da sua Equipe ativa — sem escolher nada, sem soltar em segredo. Ele já nasce **revelado pra mesa toda** na hora. O resto da sua Equipe ativa fica de reserva, disponível pra Trocar durante a batalha (ver "Ou trocar" na sua ação).
- Aparece um card **"Equipe ativa"** pra **cada Treinador da mesa**, não só o seu — mas o que os outros veem ali começa como uma fileira de **Pokébolas**: pra qualquer Pokémon que ainda não foi revelado nessa batalha, só você (o dono) e o Mestre sabem quem é de verdade. Só na sua própria Equipe ativa você tem o **⠿** pra arrastar (corrigir algo na mão), e logo abaixo dela, se você tiver algum item, sua **🎒 Mochila** (ver seção própria acima).
- **É a revelação que abre ele de vez.** Assim que um Pokémon é revelado (entrando de verdade em combate, ou por você arrastar) — mesmo antes de agir — ele já aparece pra mesa inteira, ali no Time: sprite, uma **barra de PV** com o número **atual/máximo** por cima dela (verde acima de 50%, amarela entre 20% e 50%, vermelha em 20% ou menos, igual ao jogo oficial) e a Condição/Confuso como ícone (🔥 queimadura, ☠️ veneno, ⚡ paralisia, 💤 sono, ❄️ congelamento, 💫 confuso, 🌀 carregando um Movimento de 2 turnos, 😵 desmaiado). **Essa revelação é definitiva e vale também pra Equipe ativa, mas só durante essa mesma passagem pela Arena**: a partir desse momento, aquele Pokémon aparece de verdade (não mais como Pokébola, já com a mesma barra de PV numerada) na sua Equipe ativa pra todo mundo, mesmo que depois ele volte pra lá (por uma Troca) — mas assim que o Mestre encerrar a batalha ("🔄 Nova configuração"), a revelação zera pra todo o seu time, pro próximo combate começar com o mesmo segredo de sempre.
...
2. O popup já mostra **tudo direto, sem passo de categoria antes** (mesma cara do PVP): os Movimentos, os Itens da Mochila (agrupados por tipo) e os Pokémon disponíveis pra Trocar aparecem todos juntos, na mesma tela. Escolher qualquer um deles só **registra** sua escolha, ainda sem rolar dado nenhum: o popup fecha na hora e seu Pokémon fica marcado **"✅ Escolheu"** no card, esperando o resto da mesa escolher também.
   - **Movimento (Atacar)** → escolha um dos Movimentos do seu Pokémon — cada um já mostra **quem pode ser alvo** dele ("Alvo: em você mesmo", "só aliado", "aliado ou inimigo" etc.) e a Prioridade, se tiver. Sem PP, o Movimento fica bloqueado (custa 1, ou 2 se o alvo tiver a Habilidade Pressure — Cap. 8.6). Pra um Movimento de alvo manual, é só clicar em quem já está ali no campo de batalha — nada disso resolve ainda, só fica guardado até a Rodada de fato resolver.
   - **Item** → a mochila aparece separada por tipo (💊 Vida, ✨ Condição, 💫 Reviver, 🔄 Vida + Condição, 🔋 PP, 📦 Outro) — Pokébola não aparece aqui (sem sistema de captura ainda). Escolha o item e depois em quem usar — quem pode receber já fica destacado no campo, respeitando a trava de desmaiado (Vida/Vida+Condição/PP só em quem está de pé, Reviver só em quem está desmaiado). Pra um item de PP de um Movimento só (Ether, Max Ether, PP Up, PP Max), o popup ainda pede pra escolher qual dos 4 Movimentos recebe.
   - **Trocar** → não precisa arrastar nada: os Pokémon disponíveis da sua **Equipe ativa** já aparecem clicáveis, logo abaixo dos Movimentos, sob "Ou trocar" — clique em qualquer um deles (vivo, e que ainda não esteja em campo em outro lugar).
   - **🏃 Fugir** → continua um botão à parte (não tem lista pra mostrar) — registra a tentativa de fuga.
...
3. **A Rodada resolve no ritmo do Mestre**: assim que todo mundo escolheu (ou o Mestre força "Resolver Rodada"), ele vai clicando **"▶️ Avançar"** — cada clique processa uma ação, na ordem certa (ver "Iniciativa" acima), sem nenhum avanço automático. É só nesse clique que cada coisa de fato acontece:
   - **Atacar em você mesmo ou de área** resolve sozinho. Um Movimento **de campo** também resolve sozinho: Stealth Rock e Toxic Spikes armam a armadilha no Time do alvo (o efeito de verdade só chega em quem entrar em campo depois, Cap. 26.6 e 26.6-bis — Rapid Spin remove os dois do próprio campo de quem usar); os Movimentos de clima (Rain Dance, Sunny Day, Sandstorm, Hail, Snowscape, Chilly Reception) já mudam o Clima ativo de verdade (Cap. 26.9, dura 5 turnos). O resto dos Movimentos de campo continua em aberto (Cap. 25).
   ...
   - Alguns golpes bem fortes (**Giga Impact, Hyper Beam, Hydro Cannon, Blast Burn, Frenzy Plant, Rock Wrecker, Roar of Time, Prismatic Laser, Eternabeam, Meteor Assault**) fazem seu Pokémon precisar **recarregar** na Rodada seguinte (Cap. 26.4-bis): golpeiam normal na hora, mas depois seu Pokémon perde a ação inteira na próxima Rodada, **sem rolar dado nenhum** — é garantido, mesmo acontece se o golpe anterior tiver errado. Aparece o selo **😩 Recarregando** no card dele nesse meio-tempo. Igual à Paralisia/Sono/Congelamento, só bloqueia Atacar — você ainda pode escolher Usar Item/Trocar/Fugir normal na Rodada de recarga.
   ...
   - Quando a ação envolve dado, o sistema rola sozinho e mostra tudo num **quadro de dado no centro da tela**, pra mesa inteira. Primeiro o **d10** do ataque gira e assenta; se o Movimento tiver Efeito Percentual, **depois** disso o **1d10** de Efeito gira e assenta (um de cada vez, nunca os dois juntos) — com uma **segunda tentativa** de 1d10 se foi Crítico e a primeira falhou (Cap. 14). O quadro mostra o resultado completo assim que os dois já rolaram — num Movimento de área, o resultado de cada alvo atingido. Some sozinho depois de alguns segundos, ou clique em **"Fechar"**/fora dele.
...
- **⬇️ Exportar CSV / ⬆️ Importar CSV / 📄 Modelo** (abaixo das fichas): igual à Equipe do RPG (ver "Exportar/Importar CSV da Equipe" acima) — mesmas colunas (Espécie/Apelido/Natureza/Habilidade/Movimentos), mas totalmente **independente**: importar aqui nunca mexe no seu Time do RPG, e vice-versa. Diferente da Equipe (Mestre-only), aqui **você mesmo** pode importar — é a sua própria ficha de PVP. Fica bloqueado se alguma das suas fichas estiver numa batalha em andamento (espere terminar).
