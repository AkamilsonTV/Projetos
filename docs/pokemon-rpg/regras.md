...
- **Bônus fixo de Atributo Efetivo**: Guts (com alguma Condição), Hustle/Huge Power/Pure Power (sempre), Defeatist (PV ≤ metade do máximo, penalidade), Protosynthesis/Quark Drive (sempre, no Atributo mais alto) — entram direto no Atributo Efetivo, aparecem na própria ficha, não só em combate.
...
Na Arena do site, esse cálculo é automático: o Mestre clica "▶️ Iniciar Batalha" **uma vez**, no começo, e o site já monta a fila (recalculando a Velocidade Efetiva de quem está em campo, incluindo o −10 de Paralisia do Cap. 20.4) e rola os empates sozinho. Assim que essa Rodada termina — todo mundo já agiu, ou saiu de campo —, a **próxima já é calculada sozinha**, no mesmo critério, sem precisar de mais nenhum clique do Mestre; isso se repete Rodada após Rodada até a batalha acabar. "🔁 Recalcular" continua disponível pro Mestre forçar um recálculo manual da Rodada corrente do zero quando quiser (por exemplo, depois de editar Atributos/Velocidade na mão), mas deixou de ser obrigatório a cada Rodada. A fila fica visível pra mesa inteira; com uma Rodada ativa, só quem está com a vez consegue agir (e só uma vez por Rodada) — o Mestre é a única exceção, podendo agir por qualquer entrada fora de ordem a qualquer momento, pra adjudicar a negociação de Prioridade do Cap. 17 ao vivo. Sem Rodada ativa, continua liberado pra todo mundo.

Um Pokémon que entra de surpresa numa Rodada já em andamento — o Mestre metendo alguém novo na Arena, ou uma reposição forçada por desmaio fora da própria vez (Cap. 59) — também entra no cálculo **dessa mesma Rodada**, não só na seguinte: comparando a própria Velocidade Efetiva só contra quem **ainda não agiu** (a partir de quem está com a vez agora em diante), ele pula na frente de quem for mais lento que ele — inclusive de quem está prestes a agir —, mas nunca pula quem já agiu. Uma troca voluntária durante a própria vez de alguém (Cap. 18, escolher "Trocar" como ação) continua consumindo a ação inteira como sempre — quem entra nesse caso só age a partir da Rodada seguinte.

## Capítulo 17 — Prioridade

Movimentos preservam seus valores oficiais de Prioridade (+1, +2, negativos quando aplicável).

### 17.1 A janela de Prioridade

A Velocidade determina quem teria a vez normalmente. Antes desse jogador revelar seu Movimento, o Mestre permite que o jogador fora da vez declare um Movimento de Prioridade (revelando o nome — a escolha fica comprometida). O Mestre então pergunta ao jogador da vez se quer responder com Prioridade própria.

### 17.2 Se o jogador da vez não responder

O adversário executa seu Movimento prioritário primeiro; depois, se ainda puder agir, o jogador da vez age.
...
**A Arena do site automatiza essa janela — no mesmo momento descrito acima, ANTES do jogador da vez rolar o próprio Movimento.** A ordem certa é: Turno do Pokémon → se sobrar alguém do lado OPOSTO, com uma Rodada de Iniciativa ativa (Cap. 16), que ainda não agiu nessa Rodada e tem, no próprio conjunto de 4, um Movimento de Prioridade estritamente maior que o que está prestes a ser usado (empate continua com quem já estava agindo, 17.3) — o site PAUSA esse ataque (sem rolar Precisão/Crítico/Dano nenhum ainda) e pergunta. Quem tem a Prioridade disponível (o dono do Pokémon reagindo, ou o Mestre) vê um popup com a pergunta: "Seu oponente usou X, mas você possui Y que tem uma Prioridade Z. Deseja usar Y?"; o resto da mesa vê um popup igual, só que genérico ("Verificando prioridade, aguarde."), sem revelar quem está reagindo nem com o quê, até a pergunta ser respondida. **Sim** resolve o Movimento Y de verdade primeiro (contra quem provocou a pergunta, se ele precisar de um alvo manual) e **encerra o turno desse Pokémon** — ele não age de novo quando a vez dele chegar normalmente na fila, porque já adiantou o próprio turno — e só DEPOIS disso o ataque que ficou pausado é retomado, se quem ia agir ainda conseguir (pode ter desmaiado com o golpe da reação, ou a batalha pode ter acabado no meio do caminho); **Não** só descarta a pergunta, sem gastar nada, e o ataque pausado é destravado na hora e resolve normal, como se a Prioridade nunca tivesse entrado no meio. Cada Pokémon só reage **uma vez por Rodada**, e só se ainda não tiver agido nela. Uma reação aceita pode abrir uma NOVA pergunta em cadeia — o Movimento que acabou de resolver vira a nova referência, e quem estiver do lado oposto DELE com Prioridade ainda maior (e ainda não tiver agido) pode reagir por sua vez, antes do ataque original (mais atrás na fila) finalmente ser retomado — sempre termina, porque cada reação aceita tira aquele Pokémon do grupo de "quem ainda não agiu" pro resto da Rodada. Enquanto uma pergunta estiver pendente, ninguém mais consegue agir na Arena até ela ser respondida. Com uma Rodada ativa, atacar fora da vez continua bloqueado pro jogador comum — só o Mestre pode agir por qualquer entrada fora de ordem, se precisar corrigir algo na mesa. A fila avança sozinha quando quem estava na vez termina de agir de verdade (senão fica parada até o Mestre ou o dono do Pokémon da vez clicarem "Próximo").
...
Na Arena do site, Paralisia, Sono e Congelamento (20.4/21/22) já são testados sozinhos assim que o Pokémon afetado é selecionado pra agir, na mesma ordem do Cap. 24 (antes da Confusão) — o site já rola o(s) dado(s), mostra o resultado num aviso e no Registro, e só libera (ou não) o menu de ação de acordo. Sono conta o número do turno sozinho (1º obrigatório, 2º-3º testados, acorda garantido depois disso).
...
Na Arena do site, os passos 4 a 9 (Precisão, Crítico, Dano Base, Tipos, Dano Final e Efeito Percentual) já são resolvidos automaticamente ao escolher o Movimento — ver o Guia do Treinador/Guia do Mestre. O passo 3 inteiro já é automático: Paralisia, Sono e Congelamento (Cap. 20.4/21/22) são testados sozinhos primeiro, e Confusão (Cap. 23) logo depois, assim que o Pokémon é selecionado pra agir — nessa ordem. O passo 10 também já é automático para Queimadura, Veneno e Veneno Grave (Cap. 20): o dano é aplicado sozinho logo depois que o próprio Pokémon afetado termina de agir, sem precisar esperar o fim da rodada inteira. Recuo, Dreno e Movimentos de cura (Cap. 25) também já entram nessa mesma resolução automática, na porcentagem oficial de cada Movimento. Magic Guard bloqueia qualquer um desses PV que não venham de um golpe batendo direto no Pokémon (status por turno, recuo, Confusão, Liquid Ooze, Rough Skin/Iron Barbs, Aftermath). Os passos 1 e 2 (Prioridade e quem age primeiro) continuam por conta do Mestre na mesa — exceto que, com uma Rodada de Iniciativa ativa, só quem está com a vez consegue agir (o Mestre continua podendo agir por qualquer um, fora de ordem, pra adjudicar a Prioridade).
