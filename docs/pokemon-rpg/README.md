...
- **Movimentos, Treinador**: escolhe os próprios 4 Movimentos, mas restrito ao que a espécie realmente pode aprender — três abas por slot (**Normal** = aprendizado natural por Nível, só até o teto liberado pelo Nível do Treinador (Cap. 8.2/8.4); **TM**/**HM** = só o que a espécie aprende por aquela via, sem depender de Nível). Os dados de aprendizado (learnset) também vêm do PokeAPI: HM usa como referência a última geração que ainda tinha HM (Omega Ruby/Alpha Sapphire — o Gen 7 substituiu por Pokémon de Montaria).
