...
- **Trocar/Fugir**: **Trocar de Pokémon** (`DT.arenaSwapIn`) troca por outro Pokémon do mesmo Treinador já no Time, ainda não revelado e vivo — consome a ação inteira (Cap. 18). **Fugir** (`DT.arenaFlee`) remove o Pokémon da Arena e registra no log.
