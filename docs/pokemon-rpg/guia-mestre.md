...
- **Você vê todo mundo sempre**, revelado ou não — é o único papel com visão total da Arena. Os Treinadores só veem os próprios Pokémon e os que já foram revelados (agiram alguma vez); o resto aparece como Pokébola pra eles. Um Pokémon revelado mostra uma **barra de PV** com três cores (verde/amarela/vermelha, conforme o PV atual) visível pra mesa inteira.
...
2. Se a ação seguir, abre um menu com quatro opções: **Atacar**, **Usar Item**, **Trocar de Pokémon**, **Fugir**.
   ...
   - **Trocar de Pokémon** → escolha outro Pokémon do mesmo Treinador que já esteja nesse Time da Arena, ainda não revelado e não Desmaiado, pra entrar no lugar. Consome a ação inteira (Cap. 18) — o que entrou só age a partir do turno seguinte dele.
   - **Fugir** → tira o Pokémon da Arena; fica registrado no Registro.
