...
Com uma Rodada ativa, **só quem está com a vez pode agir** — e só uma vez por Rodada; os outros Treinadores veem o próprio Pokémon "esperando" até a fila chegar nele. **Você é a única exceção**: pode agir por qualquer entrada, fora de ordem, a qualquer momento — é assim que se adjudica a negociação de Prioridade do Cap. 17 ao vivo (deixar o jogador fora da vez declarar o Movimento de Prioridade dele primeiro, olhando a Prioridade que aparece no painel de ataque). Sem Rodada ativa (antes de "Iniciar Rodada", ou depois de "Encerrar"), continua liberado pra todo mundo, como sempre foi. Quando quem está com a vez ataca, a fila passa pro próximo sozinha; fora isso, **"⏭️ Próximo"** também pode ser clicado pelo dono do Pokémon da vez, não só por você — não precisa ficar de babá clicando a cada turno.
...
O que o motor **não** faz sozinho — continua sendo você quem conduz: a janela de negociação de Prioridade (Cap. 17) e o efeito de verdade de Movimentos de campo ou de suporte sem status (Helping Hand, Aromatherapy, etc. — Cap. 25). Paralisia, Sono, Congelamento e Confusão já são automáticos, como descrito acima. Itens de Vida, Condição e PP já curam/recarregam de verdade (ver "Usar Item" acima); qualquer outro item continua sem efeito mecânico.
