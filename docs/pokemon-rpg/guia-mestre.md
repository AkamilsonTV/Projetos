...
2. Se a ação seguir, abre um menu com quatro opções: **Atacar**, **Usar Item**, **Trocar de Pokémon**, **Fugir**.
   - **Atacar** → escolha o Movimento no painel que aparece — cada botão já mostra o **Alvo** dele (Cap. 8.5: em você mesmo, só aliado, você ou aliado, só inimigo, aliado ou inimigo, ou uma categoria de área) e a Prioridade, se tiver. O que acontece depois depende da lógica do Movimento escolhido, sem exceção:
     ...
     - **Negociação de Prioridade (Cap. 17.1-17.3), agora automática**: assim que o Movimento resolve de vez, o site confere sozinho se sobra alguém do lado oposto — com uma Rodada ativa, ainda sem ter agido nela — que tenha um Movimento no próprio conjunto de 4 com Prioridade **maior** que a que acabou de ser usada (empate não conta, Cap. 17.3). Se tiver, aparece um card de pergunta pro dono desse Pokémon (ou você): *"Seu oponente usou X, mas você possui Y que tem uma prioridade Z. Deseja usar Y?"*. **Sim** já resolve Y de verdade na hora (contra quem provocou a pergunta, se precisar de um alvo — rodando os mesmos testes de Paralisia/Sono/Congelamento/Confusão de sempre antes) e **encerra o turno desse Pokémon**, mesmo que a fila normal ainda não tivesse chegado nele (a fila pula ele sozinha depois, sem perguntar de novo). **Não** só descarta a pergunta sem gastar nada — ele continua elegível pra agir na própria vez, ou reagir de novo se outro Movimento abrir uma nova pergunta antes disso. Cada Pokémon só usa essa reação **uma vez por Rodada**. Uma reação aceita pode abrir uma NOVA pergunta em cadeia (Prioridade ainda maior do lado oposto reagindo à reação) — sempre termina sozinha, sem loop, porque cada reação aceita tira aquele Pokémon do grupo de "ainda não agiu" pro resto da Rodada. Enquanto tiver uma pergunta pendente, ninguém mais consegue abrir o menu de ação (nem você) até ela ser respondida.
