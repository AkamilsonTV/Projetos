...
- **Kit de Movimentos**: os 4 mais altos do Learnset por Nível na captura/level up, mas dá pra customizar depois via 🔁 Troca de Movimento (Nível liberado = 10 Energia, MT em estoque = grátis) — nunca um Movimento fora do Learnset real da Espécie (nem por Nível nem por MT).
